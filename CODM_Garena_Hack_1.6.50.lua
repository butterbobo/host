...
function applyPatch(lib, offset, edit, flags) local ranges=gg.getRangesList(lib) if #ranges==0 then gg.alert("Error: ".. lib .." not found") else local vx={} vx[1]={} vx[1].address=ranges[1].start + offset vx[1].flags=flags vx[1].value=edit gg.setValues(vx) end end
